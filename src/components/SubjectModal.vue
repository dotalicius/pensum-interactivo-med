        ...
        <form @submit.prevent="saveDetails">
          ...
          <div class="flex items-center justify-between p-6 border-b border-gray-200">
            <div>
              ...
              <div class="space-y-1">
                ...
                <div class="flex items-center space-x-2 text-xs">
                  <span class="bg-gray-100 text-black px-2 py-1 rounded">
            ...
            <button
              type="button"
              @click="closeModal"
              class="text-black hover:text-black transition-colors duration-200"
            >
              <X class="w-6 h-6" />
            </button>
          </div>
          ...
          <div class="p-6 space-y-6">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
              <h3 class="font-medium text-black mb-3">Estado Actual</h3>
              <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-2">
                  ...
                  <button
                    v-if="store.selectedSubject.status !== 'pending'"
                    type="button"
                    class="bg-gray-100 hover:bg-gray-200 text-black px-3 py-1 rounded text-sm transition-all duration-200"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="block text-sm font-medium text-black mb-1"> Comisión </label>
                <input
                  v-model="formData.commission"
                  type="text"
                  class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm text-black focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Ej: 1A"
                />
              </div>

              <div>
                <label class="block text-sm font-medium text-black mb-1"> Profesor </label>
                <input
            ...
            <div>
              <label class="block text-sm font-medium text-black mb-1"> Horarios </label>
              <input
            ...
            <!-- Fechas de examen -->
            <div>
              <label class="block text-sm font-medium text-black mb-1"> Fechas de Examen </label>
              <div class="space-y-2">
                <div
                ...
                >
                  <input
                    ...
                    type="text"
                    class="flex-1 border border-gray-300 rounded-md px-3 py-2 text-sm text-black focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="block text-sm font-medium text-black mb-1"> Notas de Cursada </label>
                <div class="space-y-2">
                  <div
              ...
              <div>
                <label class="block text-sm font-medium text-black mb-1"> Nota Final </label>
                <input
          ...
          >
            <button
              type="button"
              @click="closeModal"
              class="px-4 py-2 text-black bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors duration-200"
            >
              Cancelar
            </button>
            <button
